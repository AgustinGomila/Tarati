...
// Colores de texto para esquema oscuro
...
// Colores de texto para esquema claro
val OnBackgroundLight = Color(0xFF3A2C5D)
val OnSurfaceLight = Color(0xFF3A2C5D)

// Color de error (armonizado con la paleta)
val ErrorVariant = Color(0xFF9D62F0)

// Opcional: Si quieres ser más específico con los colores de texto del esquema claro:
